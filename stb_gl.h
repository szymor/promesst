...
//
// The windows stuff has been hackily replaced with SDL2 stuff by David Gow.
//
...
static void stbgl__initCompTex(void)
{
	stbgl__CompressedTexImage2DARB = SDL_GL_GetProcAddress("glCompressedTexImage2DARB");
}
#endif // _WIN32
